...
// ProductDomain is an autogenerated mock type for the ProductDomain type
type ProductDomain struct {
	mock.Mock
}

// AddProduct provides a mock function with given fields: produk
func (_m *ProductDomain) AddProduct(produk models.Produk) error {
...
func (_m *ProductDomain) AddSaldo(saldobaru int, kategoriid uint) error {
...
func (_m *ProductDomain) DeleteProdukById(id uint) error {
	ret := _m.Called(id)
...
func (_m *ProductDomain) GetKategori() []models.Kategori {
	ret := _m.Called()
...
func (_m *ProductDomain) GetProdukById(id uint) models.Produk {
	ret := _m.Called(id)
...
func (_m *ProductDomain) GetProdukByKategori(kategoriid uint) []models.Produk {
...
func (_m *ProductDomain) GetProdukByKategoriProvider(kategoriid uint, providerid uint) []models.Produk {
...
func (_m *ProductDomain) GetProviderByKategori(kategoriid uint) interface{} {
	ret := _m.Called(kategoriid)
...
func (_m *ProductDomain) GetPurchaseableProduct(kategoriid uint, providerid uint) interface{} {
	ret := _m.Called(kategoriid, providerid)
...
func (_m *ProductDomain) GetSaldo() []models.Saldo {
	ret := _m.Called()
...
func (_m *ProductDomain) UpdateProductById(id uint, produk models.Produk) error {
...
type mockConstructorTestingTNewProductDomain interface {
	mock.TestingT
	Cleanup(func())
}

// NewProductDomain creates a new instance of ProductDomain. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewProductDomain(t mockConstructorTestingTNewProductDomain) *ProductDomain {
	mock := &ProductDomain{}
	mock.Mock.Test(t)

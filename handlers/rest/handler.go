...
func RegisterMainAPI(e *echo.Echo, conf config.Config) {
	...
	produkAPI.GET("", controllerProduk.AmbilProdukBerdasarkanProviderKategori, middleware.RemoveTrailingSlash(), middleware.Logger())
	produkAPI.GET("/pilih", controllerProduk.AmbilProdukBisaDibeli, middleware.RemoveTrailingSlash(), middleware.Logger())
	...
	kategoriAPI.GET("", controllerProduk.AmbilKategori, middleware.RemoveTrailingSlash(), middleware.Logger())
	kategoriAPI.GET("/produk/:id", controllerProduk.AmbilProdukBerdasarkanKategori, middleware.RemoveTrailingSlash(), middleware.Logger())
	kategoriAPI.POST("/saldo", controllerProduk.TambahSaldo, middleware.RemoveTrailingSlash(), middleware.Logger())
	kategoriAPI.GET("/saldo", controllerProduk.AmbilSaldo, middleware.RemoveTrailingSlash(), middleware.Logger())
